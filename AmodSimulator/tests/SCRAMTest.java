...
public class SCRAMTest {
    ...
    @Test
    public void objectBasedSCRAMTest1() {
...
//        Utility.setDistances(graph);
    ...
    @Test
    public void objectBasedSCRAMTest2() {
...
//        Utility.setDistances(graph);
    ...
    @Test
    public void IndexBasedSCRAMTest2() {
        Graph graph = new MultiGraph("Graph #2");
        graph.setAutoCreate(true);
        graph.setStrict(false);
...
//        Utility.setDistances(graph);
        ...
        IndexBasedSCRAM s = new IndexBasedSCRAM(vehicleList, requestList);
        Assert.assertEquals(13, s.getLongestEdgeWeight());

        List<Edge> sortedAssignmentList = new ArrayList<>(s.getAssignments());
        Collections.sort(sortedAssignmentList);

        Assert.assertEquals(0, sortedAssignmentList.get(1).getStartIndex());
        Assert.assertEquals(1, sortedAssignmentList.get(1).getEndIndex());
        Assert.assertEquals(1, sortedAssignmentList.get(2).getStartIndex());
        Assert.assertEquals(2, sortedAssignmentList.get(2).getEndIndex());
        Assert.assertEquals(2, sortedAssignmentList.get(3).getStartIndex());
        Assert.assertEquals(0, sortedAssignmentList.get(3).getEndIndex());

    }


    @Test
    public void objectBasedSCRAMTest3() {
...
//        Assert.assertEquals(3, s2.getLongestEdgeWeight());
    ...
    @Test
    public void indexBasedSCRAMTest3() {
        Graph graph = new MultiGraph("Graph #3");
        graph.setAutoCreate(true);
        graph.setStrict(false);
...
//        Utility.setDistances(graph);
        ...
        Assert.assertEquals(2, sortedAssignmentList.get(0).getStartIndex());
        Assert.assertEquals(0, sortedAssignmentList.get(0).getEndIndex());
        Assert.assertEquals(1, sortedAssignmentList.get(1).getStartIndex());
        Assert.assertEquals(1, sortedAssignmentList.get(1).getEndIndex());
        Assert.assertEquals(0, sortedAssignmentList.get(2).getStartIndex());
        Assert.assertEquals(2, sortedAssignmentList.get(2).getEndIndex());
    }

    @Test
    public void objectBasedSCRAMTest4() {
...
//        Assert.assertEquals(3, s2.getLongestEdgeWeight());
    ...
    @Test
    public void indexBasedSCRAMTest4() {
        Graph graph = new MultiGraph("Graph #4");
        graph.setAutoCreate(true);
        graph.setStrict(false);
